...
console.log(
  'The time 20 seconds from now will be ' + stamp.getFuturePastSecondDate(20),
);
console.log(
  'The time 20 minutes from now will be ' + stamp.getFuturePastMinuteDate(20),
);
console.log(
  'The time 3 hours from now will be ' + stamp.getFuturePastHourDate(3),
);
console.log(
  'The time 3 days from now will be ' + stamp.getFuturePastDayDate(3),
);
console.log(
  'The time 3 weeks from now will be ' + stamp.getFuturePastWeekDate(3),
);
console.log(
  'The time 3 months from now will be ' + stamp.getFuturePastMonthDate(3),
);
console.log(
  'The time 3 years from now will be ' + stamp.getFuturePastYearDate(3),
);
...
form.addEventListener('submit', function (event) {
  ...
  results.innerText = `The date and time ${formNum.value} ${
    formUnits.value
  } from now will be ${stamp.getFuturePastDate(
    formNum.value,
    formUnits.value,
  )}`;
});
